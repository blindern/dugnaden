...
// https://foreningenbs.no/simplesaml/saml2/idp/metadata.php?output=xhtml
$metadata['https://foreningenbs.no/simplesaml/saml2/idp/metadata.php'] = array(
    'SingleSignOnService'  => [
        [
            'Binding' => 'urn:oasis:names:tc:SAML:2.0:bindings:HTTP-Redirect',
            'Location' => 'https://foreningenbs.no/simplesaml/saml2/idp/SSOService.php',
        ],
    ],
    'SingleLogoutService'  => [
        [
            'Binding' => 'urn:oasis:names:tc:SAML:2.0:bindings:HTTP-Redirect',
            'Location' => 'https://foreningenbs.no/simplesaml/saml2/idp/SingleLogoutService.php',
        ],
    ],
